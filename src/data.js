...
const generateImages = (count, prefix = '', ext = '.jpg') => {
    return Array.from({ length: count }, (_, i) => ({
        id: `generated-${i}`,
        category: 'birthday',
        src: `/images/anitha/${i + 2}${ext}`, // Starting from 2.jpg based on file list
...
export const heroImage = '/images/Poster_6 copy.jpg';
